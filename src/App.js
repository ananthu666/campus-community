          ...
          <div className="about-container">
            <div className="about-description">
              <p>
                ...
                nam ea, aliquam totam adipisci perspiciatis eligendi facilis
                suscipit excepturi voluptatem! Vel tempora voluptatem, odit sint
                dolore iusto corporis aliquam obcaecati nulla nam praesentium
                ipsam animi excepturi temporibus consectetur repellat commodi
                similique, odio accusamus laboriosam? Odio quia assumenda
                praesentium animi quidem!
              </p>
            </div>
          ...
          <div className="about-container">
            ...
            <div className="about-description">
              <p>
                ...
                and further their careers. Campus communities will help college
                students who don't think they're getting enough exposure to
                technology or don't have the ideal environment to study it.
              </p>
            </div>
          </div>
        </div>
